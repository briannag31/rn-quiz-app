...
import { View, Text, Button, StyleSheet, KeyboardAvoidingView, TouchableWithoutFeedback, ToastAndroid, TouchableOpacity } from 'react-native';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { TextInput } from 'react-native-gesture-handler';
import {readScore} from '../assets/scoreStorage';
import Title from '../components/title';

const SignUp = (props, {score}) => {
                ...
                <View >
                    ...
                    </View>
                    {
                        (scoreString!== 'noscore' && scoreString !== null) ? <View style={styles.scoreContainer}>
                            <Text style={styles.scoreText}>Your Most Recent Score: {scoreString}</Text>
                        </View> : null
                    }
                </View>
            </TouchableWithoutFeedback>
